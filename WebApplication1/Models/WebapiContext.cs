...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-A6UAAHF\\SQLEXPRESS;Database=webapi;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Author>(entity =>
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Author__86516BCFEDAD1058");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__490D1AE1B5E12D6A");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__6E32B6A5B09A113A");
        ...
        {
            entity.HasKey(e => e.PubId).HasName("PK__Publishe__2515F2223A022837");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CCB2B14C95");
    ...
    public DbSet<WebApplication1.Models.Mobiles> Mobiles { get; set; }
    public DbSet<WebApplication1.Models.Login> Logins { get; set; }
